...
def do_generate_ramapp_upload_instructions(args):
    ...
    def lui(rs, immediate):
        return fhex(bitstruct.pack('u16u6u5u5',
                                   immediate,
                                   0b010000,
                                   0b01101,
                                   rs))
    ...
    def swm32(reglist, base, offset):
        return fhex(bitstruct.pack('u4u12u6u5u5',
                                   0b1101,
                                   offset,
                                   0b001000,
                                   reglist,
    ...
    for i in range(0, len(pairs), 512):
        ...
        for j in range(0, len(chunkpairs), 10):
            ...
            if len(subpairs) == 1:
                gprs = []
            elif len(subpairs) < 10:
                gprs = list(range(16, 16 + len(subpairs)))
            else:
                gprs = list(range(16, 24)) + [30]
